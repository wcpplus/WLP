 ...
 *说明：
 */
public interface AppbindobjDaoInter  {
 /** 删除一个应用绑定对象实体
 * @param entity 实体
 */
 public void deleteEntity(AppbindObj appbindobj) ;
 /** 由应用绑定对象id获得一个应用绑定对象实体
 * @param id
 * @return
 */
 ...
 */
 ...
 /**
 * 条件删除应用绑定对象实体，依据对象字段值(一般不建议使用该方法)
 * 
 * @param rules
 *            删除条件
 */
 ...
 /**
 * 条件查询应用绑定对象实体，依据对象字段值,当rules为空时查询全部(一般不建议使用该方法)
 * 
 * @param rules
 *            查询条件
 * @return
 */
 ...
 /**
 * 条件修改应用绑定对象实体，依据对象字段值(一般不建议使用该方法)
 * 
 * @param values
 *            被修改的键值对
 * @param rules
