 ...
 */
@Repository
public class AppbindresourceDaoImpl  extends HibernateSQLTools<AppbindResource> implements  AppbindresourceDaoInter {
  ...
  public void deleteEntity(AppbindResource appbindresource) {
    ...
    session.delete(appbindresource);
  }
  @Override
  ...
  public AppbindResource getEntity(String appbindresourceid) {
    // TODO 自动生成代码,修改后请去除本注释
    Session session= sessionFatory.getCurrentSession();
    return (AppbindResource)session.get(AppbindResource.class, appbindresourceid);
  }
  @Override
  public AppbindResource insertEntity(AppbindResource appbindresource) {
    // TODO 自动生成代码,修改后请去除本注释
    Session session= sessionFatory.getCurrentSession();
    session.save(appbindresource);
    return appbindresource;
  }
  @Override
  public void editEntity(AppbindResource appbindresource) {
    // TODO 自动生成代码,修改后请去除本注释
    Session session= sessionFatory.getCurrentSession();
    session.update(appbindresource);
  }
