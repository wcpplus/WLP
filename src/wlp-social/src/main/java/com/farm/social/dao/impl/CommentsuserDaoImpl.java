 ...
 */
@Repository
public class CommentsuserDaoImpl  extends HibernateSQLTools<CommentsUser> implements  CommentsuserDaoInter {
  ...
  public CommentsUser getEntity(String commentsuserid) {
    // TODO 自动生成代码,修改后请去除本注释
    Session session= sessionFatory.getCurrentSession();
    return (CommentsUser)session.get(CommentsUser.class, commentsuserid);
  }
  @Override
