...
<title>学习中课程- <PF:ParameterValue key="config.sys.title" /></title>
			...
			<div class="row">
				<div class="col-md-3">
					<jsp:include page="commons/include-learn-leftmenu.jsp"><jsp:param
							name="current" value="current" /></jsp:include>
				</div>
				<div class="col-md-9">
					<div style="margin-top: 20px;">
						<div class="wlp-userspace-h2">学习中课程</div>
								...
								<c:forEach items="${result.resultList }" var="node">
									<li><div class="media">
											...
											<div class="media-body"
												...
												<div>
													<div>
														已学<span style="color: #f01414;"> ${node.PROCESS}% </span>学习至<span
															style="color: #f01414;">${node.HOURTITLE }</span>
													</div>
													<div
														style="border-bottom: 1px solid #eeeeee; padding-bottom: 20px; text-align: right;">
														<a target="_blank"
															href="hourweb/PubContinue.do?classid=${node.CLASSID}"
															class="btn btn-danger btn-sm">继续学习</a> <a
															onclick="delClass('${node.CLASSID}')" type="button"
															class="btn btn-warning btn-sm">刪除课程</a> <a
															target="_blank"
