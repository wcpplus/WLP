...
<body>
	...
	<div class="container-fluid "
		...
		<div class="container">
			<div class="row wlp-column-title">
				<div class="col-xs-12">
					<span class="main">推荐课程</span> <span class="note"><PF:FormatTime
							date="${tops[0].ctime}" yyyyMMddHHmmss="yyyy年MM月dd日" />更新</span>
				</div>
			</div>
			<div class="row ">
	...
	<div class="container-fluid"
		...
		<div class="container" style="margin-top: 50px;margin-bottom: 50px;">
			<div class="row wlp-column-title">
				<div class="col-xs-12">  
					<span class="main">最新专业</span> <span class="note">${newMajor.resultList[0].ETIME}更新</span>
				</div>
			</div>
			<div class="row ">
