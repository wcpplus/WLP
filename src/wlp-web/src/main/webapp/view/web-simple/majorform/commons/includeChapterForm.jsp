		...
		<div class="modal-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="form-group" id="noteGroupId">
									<label for="noteId" class="control-label">学习步骤简述&nbsp;<span
			...
			<div class="modal-footer">
				<button type="button" id="chapterSubmitButtonId"
					onclick="submitChapterForm();" class="btn btn-success">提交学习步骤</button>
				<p class="bg-danger"
...
<script>
	...
	function submitChapterForm() {
		...
		if (confirm("是否提交本学习步骤？")) {
			$('#chapterSubmitButtonId').attr('disabled', 'disabled');
			$.post('majorweb/savechapter.do', {
				'title' : $('#titleId').val(),
				'note' : $('#noteId').val(),
				'majorid' : $('#majorId').val(),
				'sort' : $('#sortId').val(),
