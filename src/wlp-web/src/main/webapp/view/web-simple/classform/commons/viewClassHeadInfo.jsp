	...
	<ul style="margin-left: -20px;">
		<c:forEach items="${classview.types }" var="node" varStatus="stat">
			<li style="list-style-type: none; float: left;"><a
				href="category/Pubview.do?typeid=${node.id}"> <c:if
...
<div class="wlp-userspace-h2">
	...
	<span class="label label-default"
		style="padding-top: 4px; font-weight: 200; font-size: 14px;">时长:${classview.classt.altime}分钟</span>
	<span class="label label-default"
		style="padding-top: 4px; font-weight: 200; font-size: 14px;">作者:${classview.classt.outauthor}</span>
	<c:forEach items="${classview.tags }" var="node">
		<span class="label label-warning"
			style="padding-top: 4px; font-weight: 200; font-size: 14px;">${node.name}</span>
	</c:forEach>
</div>
<div style="padding: 15px; text-shadow: 0px 0px 18px #000000;color: #eeeeee;"> 
