	...
	<c:if test="${!empty classview}">
		<ul class="nav nav-pills nav-stacked">
			...
			<li role="presentation" ${param.type=='introduction'?'class="active"':'' }><a
				href="classweb/mng.do?classid=${classview.classt.id}&type=introduction"><i class="glyphicon glyphicon-blackboard"></i>&nbsp;&nbsp;修改课程介绍</a></li>
			<li role="presentation" ${param.type=='chapter'?'class="active"':'' }><a
				href="classweb/mng.do?classid=${classview.classt.id}&type=chapter"><i class="glyphicon glyphicon-dashboard"></i>&nbsp;&nbsp;维护章节课时</a></li>
			<li role="presentation" ${param.type=='tags'?'class="active"':'' }><a
				href="classweb/mng.do?classid=${classview.classt.id}&type=tags"><i class="glyphicon glyphicon-tags"></i>&nbsp;&nbsp;维护课程标签</a></li>
			<li role="presentation" ${param.type=='resource'?'class="active"':'' }><a
				href="classweb/mng.do?classid=${classview.classt.id}&type=resource"><i class="glyphicon glyphicon-link"></i>&nbsp;&nbsp;维护课程资源</a></li>
