...
<body>
	...
	<div class="container-fluid  picLUp" style="padding-top: 20px;">
		...
		<div class="container wpl-class-tab">
			<jsp:include page="commons/viewClassTabs.jsp">
				<jsp:param name="current" value="evaluation" />
			</jsp:include>
		</div>
	</div>
	<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-9">
					<div style="margin: 20px;">
						<!-- 1:专业,2:课程,3:课时 -->
						<jsp:include page="/view/web-simple/commons/evaluationBox.jsp">
							<jsp:param name="appid" value="${classview.classt.id }" />
							<jsp:param name="apptype" value="2" />
						</jsp:include>
					</div>
				</div>
				<div class="col-md-3">
